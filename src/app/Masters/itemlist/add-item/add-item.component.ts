...
export class AddItemlistComponent implements OnInit {
  ...
  public myError = (print_name: string, errorName: string) => {
    return this.addItemlist.controls[print_name].hasError(errorName);
  }
  ...
  CheckBox(event: { checked: any; },no:any){
