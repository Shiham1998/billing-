...
export class AddeditClientComponent implements OnInit {
  ...
  Saveclient(){
   ...
   checkCheckBoxvalue(event: { checked: any; },no:any){
      ...
      console.log(no);
      var id_DOB = document.getElementById('id_DOB') as HTMLInputElement;
      var id_anniversary = document.getElementById('id_anniversary') as HTMLInputElement;
      switch(no){
        case 1 :
          if(event.checked==true&&no==1){
            id_DOB.disabled=false; 
          }else{
            id_DOB.disabled=true;
            id_DOB.value="";
          }
        break;
        case 2 :
          if(event.checked==true&&no==2){
            id_anniversary.disabled=false; 
          }else{
            id_anniversary.disabled=true;
            id_anniversary.value="";
          }
        break;
      }
    } 
